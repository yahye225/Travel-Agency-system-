...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2023 at 02:27 PM
...
ELSEIF(_action='course')THEN
SELECT id,name FROM course;


ELSEIF(_action='exam')THEN
SELECT id,name FROM exam;

ELSEIF(_action='year')THEN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `marks_sp` (`_std_id` INT, `_marks` DOUBLE, `_exam` INT, `_course` INT, `_year` INT, `_date` DATE, `_user_id` INT)   BEGIN

INSERT INTO marks(std_id,marks,exam_id,course_id,year_id,date,user_id)
VALUES(_std_id,_marks,_exam,_course,_year,_date,_user_id);
SELECT concat('success|',' Registred Success');

END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `match_class_course_sp` (`_class_id` TEXT, `_course_id` TEXT, `_exam_id` INT, `_year_id` INT, `_min` DOUBLE, `_max` DOUBLE, `_user_id` INT, `_date` DATE)   BEGIN

if EXISTS(SELECT id FROM match_class_course m WHERE find_in_set(m.class_id,_class_id) AND find_in_set(m.course_id,_course_id) AND m.exam_id=_exam_id AND m.year_id=_year_id)THEN

SELECT concat('danger|',' Xogtaan horay ayaa loo diwan galiyay');
ELSE

INSERT INTO match_class_course(class_id,course_id,exam_id,year_id,min_marks,max_marks,date,user_id)
SELECT c.id,cr.id,_exam_id,_year_id,_min,_max,_date,_user_id FROM class c CROSS JOIN course cr WHERE find_in_set(c.id,_class_id) AND find_in_set(cr.id,_course_id);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `rp_marks_sp` (`_class_id` INT, `_course_id` INT, `_exam_id` INT, `_year_id` INT, `_user_id` INT)   BEGIN
SELECT m.min_marks,m.max_marks INTO @min_marks,@max_marks FROM match_class_course m WHERE m.exam_id=_exam_id AND m.class_id=_class_id AND m.year_id=_year_id LIMIT 1;

SELECT 'marks_sp' `sp~req sp hide`,s.std_id `Student Id~req std_id`,s.name `Student Name`,'' `Marks~req marks~contenteditable`,_exam_id `_exam_id~req hide exam`,_course_id `_course_id~req  hide course`,_year_id `_year_id~req year hide`,now() `date~req hide date`,_user_id `_user_id~req hide user`,@min_marks `min~req hide  min`,@max_marks `max~req  max`,
concat('<button style="font-size:22px;color:green" class="fa fa-save marks-entry"><button>')`Save` FROM student_view s WHERE s.class_id=_class_id ;
...
(35, 'sss', 'forms/gen_form.php', 1, 'academic_year_sp', 'tools/insert_anny.php,tools/report.php', 'Add'),
(36, 'Add Courses', 'forms/gen_form.php', 3, 'course_sp', 'tools/insert_anny.php', 'Add'),
(37, 'Match Exam', 'forms/gen_form.php', 3, 'match_class_course_sp', 'tools/insert_anny.php', 'Add'),
(38, 'Marks Entry', 'forms/gen_report.php', 3, 'rp_marks_sp', 'tools/report.php', 'Search');
...
(81, '', ' sp name', '_sp_name', 'Enter  sp name', NULL, NULL, NULL, 32),
...
INSERT INTO `marks` (`id`, `std_id`, `marks`, `exam_id`, `course_id`, `year_id`, `date`, `user_id`, `status`) VALUES
(1, 1004, 10, 6, 1, 1, '2023-05-09', 2, '0'),
(2, 1004, 13, 6, 1, 1, '2023-05-09', 2, '0'),
(3, 1004, 12, 5, 1, 1, '2023-05-09', 2, '0'),
(4, 1004, 12, 5, 1, 1, '2023-05-09', 2, '0'),
(5, 1001, 13, 5, 0, 2, '2023-05-09', 2, '0'),
(6, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(7, 1004, 12, 6, 1, 2, '2023-05-09', 2, '0'),
(8, 1004, 12, 6, 1, 2, '2023-05-09', 2, '0'),
(9, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(10, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(11, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(12, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(13, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(14, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(15, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(16, 1004, 13, 6, 1, 2, '2023-05-09', 2, '0'),
(17, 1004, 10, 6, 1, 2, '2023-05-09', 2, '0'),
(18, 1001, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(19, 1002, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(20, 1003, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(21, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(22, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(23, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(24, 1004, 10, 6, 1, 2, '2023-05-09', 2, '0'),
(25, 1005, 1, 6, 1, 2, '2023-05-09', 2, '0'),
(26, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(27, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(28, 1001, 1, 6, 1, 2, '2023-05-09', 2, '0'),
(29, 1002, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(30, 1003, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(31, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(32, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(33, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(34, 1001, 1, 6, 1, 2, '2023-05-09', 2, '0'),
(35, 1003, 1, 6, 1, 2, '2023-05-09', 2, '0'),
(36, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(37, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(38, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(39, 1004, 12, 5, 1, 2, '2023-05-09', 2, '0'),
(40, 1001, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(41, 1002, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(42, 1007, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(43, 1005, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(44, 1003, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(45, 1006, 0, 5, 1, 2, '2023-05-09', 2, '0'),
(46, 1002, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(47, 1003, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(48, 1001, 3, 6, 1, 2, '2023-05-09', 2, '0'),
(49, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(50, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(51, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(52, 1001, 3, 6, 1, 2, '2023-05-09', 2, '0'),
(53, 1002, 9, 6, 1, 2, '2023-05-09', 2, '0'),
(54, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(55, 1003, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(56, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(57, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(58, 1002, 9, 6, 1, 2, '2023-05-09', 2, '0'),
(59, 1003, 9.9, 6, 1, 2, '2023-05-09', 2, '0'),
(60, 1001, 3, 6, 1, 2, '2023-05-09', 2, '0'),
(61, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(62, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(63, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(64, 1001, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(65, 1004, 9, 6, 1, 1, '2023-05-09', 2, '0'),
(66, 1002, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(67, 1003, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(68, 1007, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(69, 1005, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(70, 1006, 0, 6, 1, 1, '2023-05-09', 2, '0'),
(71, 1004, 9, 6, 2, 2, '2023-05-09', 2, '0'),
(72, 1001, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(73, 1002, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(74, 1006, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(75, 1007, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(76, 1003, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(77, 1005, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(78, 1004, 9, 6, 2, 2, '2023-05-09', 2, '0'),
(79, 1001, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(80, 1002, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(81, 1003, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(82, 1006, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(83, 1005, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(84, 1007, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(85, 1004, 10, 6, 1, 2, '2023-05-09', 2, '0'),
(86, 1001, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(87, 1005, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(88, 1002, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(89, 1003, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(90, 1006, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(91, 1007, 0, 6, 1, 2, '2023-05-09', 2, '0'),
(92, 1004, 10, 6, 2, 2, '2023-05-09', 2, '0'),
(93, 1001, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(94, 1002, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(95, 1003, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(96, 1005, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(97, 1006, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(98, 1007, 0, 6, 2, 2, '2023-05-09', 2, '0'),
(99, 1004, 10, 6, 1, 2, '2023-05-09', 2, '0'),
(100, 1001, 9, 6, 1, 2, '2023-05-09', 2, '0'),
(101, 1003, 9, 6, 1, 2, '2023-05-09', 2, '0'),
(102, 1002, 9, 6, 1, 2, '2023-05-09', 2, '0'),
(103, 1005, 9, 6, 1, 2, '2023-05-09', 2, '0');
...
--
-- Dumping data for table `match_class_course`
--

INSERT INTO `match_class_course` (`id`, `class_id`, `course_id`, `exam_id`, `year_id`, `min_marks`, `max_marks`, `date`, `user_id`) VALUES
(1, 1, 1, 6, 2, 5, 10, '2023-05-09', 2),
(2, 1, 2, 6, 2, 5, 10, '2023-05-09', 2),
(3, 1, 3, 6, 2, 5, 10, '2023-05-09', 2),
(4, 1, 4, 6, 2, 5, 10, '2023-05-09', 2);
...
(12, 'abdi', '202cb962ac59075b964b07152d234b70', NULL, 'active', NULL, NULL, NULL, NULL),
(13, 'moha', '202cb962ac59075b964b07152d234b70', 'uploads/download.jpg', 'active', '2023-05-09', NULL, 1, 2);
